...
Теперь тесты в GitHub Action будут запускаться автоматически при каждом пуше. Это обеспечивает непрерывную интеграцию и гарантирует, что код проходит тщательную проверку.
